...
function AreaFocus() {
  ...
  return (
    <>
      <section className="flex-col gap-6 px-6 mb-8 text-white transition-all shadow-lg py-[3rem] bg-green-950 bg-items-start ">
        <div className="mb-6 text-center">
          <h2 className="text-[2.5rem] font-semibold max-md:text-[2rem]">Our Areas of Focus</h2>
          <p className="mt-4 text-[1rem]  max-md:text-[0.9rem] md:px-[10rem] max-md:px-4">
        ...
        <div className="grid grid-cols-1 gap-10 sm:grid-cols-1 md:grid-cols-2 sm:px-12 text-[0.9rem] leading-6 ">
