...
import HowToOrder from "./pages/Resources/HowToOrder";
...
const ProductSustainability = lazy(() =>
  import("./pages/Products/ProductSustainability")
);
  ...
  const router = createBrowserRouter(
    createRoutesFromElements(
      <Route element={<Layout />}>
        ...
        <Route
          path="/sustainability-development"
          element={
            <Suspense fallback={<div>Loading...</div>}>
              <SustainableDev />
            </Suspense>
        ...
        />
        <Route
          path="/export-process/how-it-works"
          element={
            <Suspense fallback={<div>Loading...</div>}>
              <HowitWorks />
            </Suspense>
