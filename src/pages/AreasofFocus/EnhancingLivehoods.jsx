    ...
    <>
      <div className="font-sans ">
        ...
        >
          ...
          <div className="relative flex items-center h-full px-5 text-white lg:px-20 md:px-10">
        ...
        <section className="px-5 mt-8 text-sm lg:px-20 md:px-10 text-secondary md:text-base">
          <nav>
